...
*/}}
{{- define "apidocs-api-chart.fullname" -}}
...
*/}}
{{- define "apidocs-api-chart.chart" -}}
...
Common labels
*/}}
{{- define "apidocs-api-chart.labels" -}}
helm.sh/chart: {{ include "apidocs-api-chart.chart" . }}
{{ include "apidocs-api-chart.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "apidocs-api-chart.selectorLabels" -}}
app.kubernetes.io/name: {{ include "apidocs-api-chart.name" . }}
...
*/}}
{{- define "apidocs-api-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "apidocs-api-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "apidocs-api-chart.image" -}}
...
*/}}
{{- define "apidocs-api-chart.imagePullSecrets" -}}
{{- $global := .Values.global | default dict -}}
